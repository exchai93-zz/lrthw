...
# create a variable amount of cheese and assign it with an integer value of 10
amount_of_cheese = 10
# create a variable amount of crackers and assign it with an integer value of 50
...
# call cheese_and_crackers, passing in the first argument as the
# computed value of the amount_of_cheese variable added to 100
# then passing in the computed value of the amount_of_crackers variable
# added to 1000
